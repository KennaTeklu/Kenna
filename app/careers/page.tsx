      ...
      <main className="flex-1">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-3xl">
            <h2 className="text-3xl font-bold text-center mb-10">Our Application Process</h2>
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                <div className="flex-none w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold">
                  1
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Apply Online</h3>
                  <p className="text-gray-600 dark:text-gray-400">
                    Fill out our simple online application form with your information and experience.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    If your application meets our requirements, we'll schedule a phone or video interview.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    For cleaning positions, we'll evaluate your cleaning skills and attention to detail.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    We conduct a thorough background check to ensure safety and security for our clients.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Once you're hired, you'll receive training and orientation to set you up for success.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-primary">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              We're always looking for dedicated individuals who share our commitment to excellence.
            </p>
